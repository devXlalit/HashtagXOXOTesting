...
const Navbar = () => {
  ...
  return (
    <div
      id="bag"
      className=" flex ring-1 z-50 bg-[#E2C799] text-black ring-zinc-200 shadow-md px-10  items-center justify-between py-3 md:py-1 font-medium"
    >
      <Link to="/">
        <img src={HashTagXOXO} alt="logo" className="h-12" />
      </Link>
      {visible && (
        <ul className="leading-8 z-50 font-normal md:flex md:flex-wrap md:static bg-[#E2C799] md:shadow-none shadow-xl py-6 md:py-4 top-16 left-0 right-0 absolute   md:flex-row flex-col justify-center items-center block md:gap-5 ">
          <li
            onMouseEnter={() => {
              setWhatnew(true);
            }}
